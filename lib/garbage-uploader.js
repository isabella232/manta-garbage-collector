...
// garbage-buckets-consumer program to process garbage collector instructions
// and send them to the appropriate storage servers.
//
...
GarbageUploader.prototype.addCounter = function addCounter(counterName, value) {
    var self = this;
...
GarbageUploader.prototype.getCounter = function getCounter(counterName) {
    var self = this;
...
GarbageUploader.prototype.getGauge = function getGauge(gaugeName) {
    var self = this;
...
GarbageUploader.prototype.setGauge = function setGauge(gaugeName, value) {
    var self = this;
...
// When run directly, starts the daemon. When imported one can create their own
// GarbageUploader object(s).
